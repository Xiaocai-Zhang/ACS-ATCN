...
class config:
    ...
    TestInpPath = '../../data/proced/StarLightCurves/test_input.csv'
    TestOupPath = '../../data/proced/StarLightCurves/test_target.csv'
    ModelPath = '../../save_model/StarLightCurves/'
    ParaPath = '../../para/StarLightCurves/parameter.csv'
    SavePath = '../../para/StarLightCurves/test_result.csv'
...
if __name__ == '__main__':
    ...
    SaveDf = pd.DataFrame({'G_mean':G_mean_li,'F1_score':f1_score_li,'Auc':auc_li,'Time':time_li})
