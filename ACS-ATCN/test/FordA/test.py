...
class config:
    ...
    TestInpPath = '../../data/proced/FordA/test_input.csv'
    TestOupPath = '../../data/proced/FordA/test_target.csv'
    ModelPath = '../../save_model/FordA/'
    ParaPath = '../../para/FordA/parameter.csv'
...
def Test(x,round_no):
    ...
    LastIdx = [idx for idx in range(500)]
