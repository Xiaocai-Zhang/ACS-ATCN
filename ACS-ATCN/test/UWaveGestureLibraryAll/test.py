...
from evaluate.multi.evaluation_test import Evaluate
...
class config:
    ...
    TestInpPath = '../../data/proced/UWaveGestureLibraryAll/test_input.csv'
    TestOupPath = '../../data/proced/UWaveGestureLibraryAll/test_target.csv'
    ModelPath = '../../save_model/UWaveGestureLibraryAll/'
    ParaPath = '../../para/UWaveGestureLibraryAll/parameter.csv'
    SavePath = '../../para/UWaveGestureLibraryAll/test_result.csv'
...
def Test(x,round_no):
    ...
    G_mean,acc,precision,f1_score,auc,mcc = Evaluate(test_oup, predictions_test)

    return G_mean,acc,precision,f1_score,auc,mcc
...
if __name__ == '__main__':
    ...
    for index,row in ParaTable.iterrows():
        ...
        G_mean,acc,precision,f1_score,auc,mcc = Test(Para_f, round_no)
    ...
    SaveDf = pd.DataFrame({'G_mean':G_mean_li,'Accuracy':acc_li,'Precision':precision_li,'F1_score':f1_score_li,'Auc':auc_li,'mcc':mcc_li,'Time':time_li})
