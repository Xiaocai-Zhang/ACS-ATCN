...
class config:
    ...
    TestInpPath = '../../data/proced/ElectricDevices/test_input.csv'
    TestOupPath = '../../data/proced/ElectricDevices/test_target.csv'
    ModelPath = '../../save_model/ElectricDevices/'
    ParaPath = '../../para/ElectricDevices/parameter.csv'
    SavePath = '../../para/ElectricDevices/test_result.csv'
