...
class config:
    ...
    TrainInpPath = '../../data/proced/StarLightCurves/train_input.csv'
    TrainOupPath = '../../data/proced/StarLightCurves/train_target.csv'
    ParaSavePath = '../../para/StarLightCurves/parameter.csv'
    ModelSavePath = '../../save_model/FordA/'

    bounds_cost = [(0, 1),(1,10),(1,20)]
    # batch, timestep, filter, layer, kernel, dropout, lr
    bounds_other = [(10, 300),(10, 1024),(1, 100),(1, 10),(1, 100),(0,1),(0.001, 0.1)]
...
def Train(x,round_no,f):
    ...
    LastIdx = [idx for idx in range(1024)]
...
def RunDE(round_no):
    ...
    SaveTextPath = '../../text/StarLightCurves/round_' + str(round_no) + '/'
