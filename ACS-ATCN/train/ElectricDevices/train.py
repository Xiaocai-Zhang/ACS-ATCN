...
from evaluate.binary.evaluation_val import Evaluate
import numpy as np
import random
import pathlib
...
class config:
    ...
    TrainInpPath = '../../data/proced/ElectricDevices/train_input.csv'
    TrainOupPath = '../../data/proced/ElectricDevices/train_target.csv'
    ParaSavePath = '../../para/ElectricDevices/parameter.csv'
    ModelSavePath = '../../save_model/ElectricDevices/'

    bounds_cost = [(0, 1),(1,20)]
    # batch, timestep, filter, layer, kernel, dropout, lr
    bounds_other = [(10, 300),(5, 96),(1, 100),(1, 10),(1, 100),(0,1),(0.001, 0.1)]
...
def Train(x,round_no,f):
    ...
    LastIdx = [idx for idx in range(96)]
...
def RunDE(round_no):
    ...
    SaveTextPath = '../../text/ElectricDevices/round_' + str(round_no) + '/'
